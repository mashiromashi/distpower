        ...
        >
          ...
          >
            <div className="table-responsive" style={{ height: "40vh" }}>
              ``` <h6>Latitude : {this.state.selectedPlace.lat}</h6>
              <h6>Longitude : {this.state.selectedPlace.lng}</h6>
              <h6>Status : {this.state.selectedPlace.name}</h6>```
              <table className="table tableInMap table-sm">
                <tbody>
                  <TR dOne="Reg No." dTwo="CRP0004" />
                  <TR dOne="Gen ID" dTwo={generatorId} />
                  ...
                  <TR dOne="Main Breaker" dTwo={sysStatusMainBreaker} />
                  <TR
                    dOne="Remote/ByPass/Maintenance"
                    dTwo={sysStatusRemote}
                    dClass="hrline"
                  />
                  <TR dOne="Incoming Panel" dClass="title" />
                  <TR dOne="Incoming Voltage" dTwo={incPanelIncVoltage} />
                  <TR dOne="Grid Frequency" dTwo={incPanelGridFrequency} />
                  <TR
                    dOne="Inverters"
                    dTwo={incPanelInverterStatus}
                    dClass="hrline"
                  />
                  <TR dOne="Standby Generator Panel" dClass="title" />
                  <TR dOne="REMU" dTwo={standByGen_remu} />
                  <TR
                    dOne="Start/Running/Stop"
                    dTwo={standByGen_start_running_stop}
                  />
                  <TR dOne="Gen Running (RMP)" dTwo={standByGen_gen_running} />
                  <TR dOne="Gen Voltage (V)" dTwo={standByGen_gen_voltage} />
                  <TR dOne="Gen Current (Amp)" dTwo={standByGen_current} />
                  <TR dOne="Gen Power (kW)" dTwo={standByGen_gen_power} />
                  <TR
                    dOne="Gen Frequency (Hz)"
                    dTwo={standByGen_gen_frequency}
                  />
